...
let hooks = {}
try {
  const module = await import('./TaskList.hooks.js')
...
export default function TaskList() {
  ...
  try {
    ...
    console.warn('TaskList: Hook context not ready during navigation:', error.message)
    return html`
  ...
  const tableActions = [
    { label: 'Edit', onClick: (item) => window.location.href = `/tasks/${item.id}/edit` },
