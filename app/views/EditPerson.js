// Generated EditPerson Component
...
let hooks = {}
try {
  const module = await import('./EditPerson.hooks.js')
...
export default function EditPerson() {
  ...
  try {
    ...
    console.warn('EditPerson: Hook context not ready during navigation:', error.message)
    return html`
  ...
  const { data, loading: loadingData, error: loadError } = usePersons()
  ...
  if (!existingItem) return html`<div class="text-center">Name not found</div>`
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true)
    try {
      await updatePerson(id, processedData)
